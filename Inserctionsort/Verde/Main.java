...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    inserctionsort.sort(c, quantidade);
    ...
    output.escrever("746639" + "\t" + inserctionsort.result + "\t" + inserctionsort.COMPARACOES_ENTRE_ELEMENTOS + "\t" + inserctionsort.MOVIMENTACOES_ENTRE_ELEMENTOS);
      ...
      public void sort(Serie[] array, int n) {  
         ...
         tempoInicial = System.currentTimeMillis();
             ...
             for (int i = 1; i < n; i++) {
                    ...
                    while ( (j >= 0) &&  (array[j].getEmissora().compareTo(tmp.getEmissora()) > 0 || 
(array[j].getEmissora().compareTo(tmp.getEmissora()) == 0 && 
