...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    selectionsort.sort(c, quantidade);
    ...
    output.escrever("746639" + "\t" +selectionsort.result + "\t" + selectionsort.COMPARACOES_ENTRE_ELEMENTOS + "\t" + selectionsort.MOVIMENTACOES_ENTRE_ELEMENTOS);
...
class Selectionsort {
  ...
  int COMPARACOES_ENTRE_ELEMENTOS = 0, MOVIMENTACOES_ENTRE_ELEMENTOS = 0;
  ...
  public void sort(Serie[] array, int n) {  
    ...
    for (int i = 0; i < (n - 1); i++) {
      ...
      COMPARACOES_ENTRE_ELEMENTOS++;
        ...
        if (array[menor].getPaísOrig().compareTo(array[j].getPaísOrig()) > 0 || (array[menor].getPaísOrig().compareTo(array[j].getPaísOrig()) == 0 && 
  ...
  static double result = ((System.currentTimeMillis() - tempoInicial));
